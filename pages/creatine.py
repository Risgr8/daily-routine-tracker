...
if creatine_date_refreshed != datetime.date.today():
    config["creatine"]["added_today"] = 0
...
if st.button("remove 5g"):
    ...
    with open('config.yaml', 'w') as file:
        yaml.dump(config, file)
st.write("current creatine amount: " + str(creatine_amount) + " g")
st.write("creatine taken today: " + str(config["creatine"]["added_today"]) + " g") 